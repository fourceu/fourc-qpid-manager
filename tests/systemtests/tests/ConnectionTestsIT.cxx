...
class ConnectionTestsIT : public ::testing::Test {
public:
  ConnectionTestsIT() : brokerAgent(std::shared_ptr<qpid::messaging::Session>()) {
...
TEST_F(ConnectionTestsIT, testGetConnections) {

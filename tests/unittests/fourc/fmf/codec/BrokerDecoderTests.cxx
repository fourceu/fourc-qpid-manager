...
TEST(BrokerDecoderTests, decodeBroker) {
  ...
  uint32_t abandoned = 1;
  uint32_t abandonedViaAlt = 2;
  uint32_t acquires = 3;
  uint32_t byteDepth = 4;
  uint32_t byteFtdDepth = 5;
  uint32_t byteFtdDequeues = 6;
  uint32_t byteFtdEnqueues = 7;
  uint32_t bytePersistDequeues = 8;
  uint32_t bytePersistEnqueues = 9;
  uint32_t byteTotalDequeues = 10;
  uint32_t byteTotalEnqueues = 11;
  uint32_t byteTxnDequeues = 12;
  uint32_t byteTxnEnqueues = 13;
  uint32_t connBacklog = 14;
  uint32_t discardsLvq = 15;
  uint32_t discardsNoRoute = 16;
  uint32_t discardsOverflow = 17;
  uint32_t discardsPurge = 18;
  uint32_t discardsRing = 19;
  uint32_t discardsSubscriber = 20;
  uint32_t discardsTtl = 21;
  uint32_t maxConns = 22;
  uint32_t mgmtPubInterval = 23;
  uint32_t msgDepth = 24;
  uint32_t msgFtdDepth = 25;
  uint32_t msgFtdDequeues = 26;
  uint32_t msgFtdEnqueues = 27;
  uint32_t msgPersistDequeues = 28;
  uint32_t msgPersistEnqueues = 29;
  uint32_t msgTotalDequeues = 30;
  uint32_t msgTotalEnqueues = 31;
  uint32_t msgTxnDequeues = 32;
  uint32_t msgTxnEnqueues = 33;
  uint32_t queueCount = 34;
  uint32_t releases = 35;
  uint32_t reroutes = 36;
